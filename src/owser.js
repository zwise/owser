!function (name, definition) {
	...
	if ((owser.msie && owser.version >= 7) ||
			(owser.chrome && owser.version >= 10) ||
			(owser.firefox && owser.version >= 4.0) ||
			(owser.safari && owser.version >= 5) ||
			(owser.opera && owser.version >= 10.0)) {
		owser.a = t;
	}

	else if ((owser.msie && owser.version < 7) ||
			(owser.chrome && owser.version < 10) ||
			(owser.firefox && owser.version < 4.0) ||
			(owser.safari && owser.version < 5) ||
			(owser.opera && owser.version < 10.0)) {
